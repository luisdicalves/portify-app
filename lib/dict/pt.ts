export const pt = {
  ...
  impAnalyze: 'Analisar ficheiro',
  impAnalyzing: 'A analisar...',
  impPreviewTitle: 'Ficheiro analisado',
  impNotSavedYet: 'Nenhum dado foi gravado ainda.',
  impReviewErrors: 'Revê os erros antes de confirmar.',
  impRowsRead: 'Linhas lidas',
  impRowsValid: 'Válidas',
  impRowsError: 'Com erro',
  impRowsDuplicate: 'Duplicadas',
  impRowsWarning: 'Avisos',
  impErrorsListTitle: 'Erros encontrados',
  impRowPrefix: 'Linha',
  impBack: 'Voltar',
  ...
  impStatusPending: 'Pendente',
  impStatusCompleted: 'Concluída',
  impStatusPartial: 'Parcial',
  impStatusFailed: 'Falhou',
