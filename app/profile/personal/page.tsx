  ...
  return (
    <div className="phone-shell" style={{ overflow: 'hidden' }}>
      ...
      <div style={{ flex: 1, overflow: 'auto', padding: '18px 16px 100px', display: 'flex', flexDirection: 'column', gap: 18 }}>
        ...
        {/* Plan section */}
        <div>
          <div style={{ fontSize: 11, fontWeight: 600, letterSpacing: '0.06em', textTransform: 'uppercase', color: 'var(--on-surface-variant)', margin: '0 6px 8px' }}>Plano</div>
          <div style={{ background: 'var(--surface-lowest)', border: '1px solid var(--card-border)', borderRadius: 'var(--radius-lg)', overflow: 'hidden' }}>
            <Row icon="savings" label="Contribuição" value="300 €/mês" onClick={() => router.push('/auth/plan-set')} border={false} />
          </div>
        </div>
